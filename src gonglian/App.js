...
//发送账户的秘钥
const privateKey = Buffer.from('7C477E1AED569586FCBCA3A0076B7D610A229B87BC1298AA5217B990072A0E27', 'hex')
...
//"0x90B61E1C322510909023B2eefA02A47A9ad9A871";
//"0x6f12fbbc9eba17d78a357f042682d6a0db57a1ae";
web3.eth.defaultAccount = '0x90B61E1C322510909023B2eefA02A47A9ad9A871';//设置使用的账户
//初始化合约信息，便于后面合约交互的abi编码发送信息
const mycontract = new web3.eth.Contract(tokenAbi,contractAddr,{
  from: '0x90B61E1C322510909023B2eefA02A47A9ad9A871',
  gasPrice: '1000000000'
} );
// 定义存储图片到ipfs函数
