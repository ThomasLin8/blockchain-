...
//发送账户的秘钥
const privateKey = Buffer.from('8aeecf4023d4cedb233f53d8e980186209e44479c17c8c1cca10597aabca76d1', 'hex')
...
let gnonce; //nonce
let ttxhash;
const contractAddr = '0x09EB328eBEE6B3D29B4c0e07c7fdEb385b3A7392';//合约地址
//"0x193465ee48FAb655238116Aa0DE18A8b4Ddf1Ad0";
//"0x6f12fbbc9eba17d78a357f042682d6a0db57a1ae";
web3.eth.defaultAccount = '0x193465ee48FAb655238116Aa0DE18A8b4Ddf1Ad0';//设置使用的账户
//初始化合约信息，便于后面合约交互的abi编码发送信息
const mycontract = new web3.eth.Contract(tokenAbi,contractAddr,{
  from: '0x193465ee48FAb655238116Aa0DE18A8b4Ddf1Ad0',
  gasPrice: '1000000000'
} );
// 定义存储图片到ipfs函数
